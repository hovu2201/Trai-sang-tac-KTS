...
// App states
export type PanelType = 'phongnam' | 'context' | 'category' | 'style' | 'materials' | 'elements' | 'dramatization' | 'aspectRatio' | 'scenery' | 'environment' | 'colors' | 'floorPlan' | 'views2d' | 'gallery';
